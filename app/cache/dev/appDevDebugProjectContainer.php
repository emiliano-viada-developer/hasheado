...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'hasheado_blog.behaviors.listener' => 'getHasheadoBlog_Behaviors_ListenerService',
            'hasheado_blog.entity_id.type' => 'getHasheadoBlog_EntityId_TypeService',
            'hasheado_blog.wysiwyg.type' => 'getHasheadoBlog_Wysiwyg_TypeService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Library/WebServer/Documents/hasheado2/app/cache/dev/annotations', true);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/Library/WebServer/Documents/hasheado2/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'HasheadoBlogBundle', '/Library/WebServer/Documents/hasheado2/app/Resources/HasheadoBlogBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'HasheadoBlogBundle', '/Library/WebServer/Documents/hasheado2/vendor/hasheado/blog-bundle/Hasheado/BlogBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, '', '/Library/WebServer/Documents/hasheado2/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/Library/WebServer/Documents/hasheado2/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventListener(array(0 => 'onFlush'), $this->get('hasheado_blog.behaviors.listener'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'hasheado2', 'user' => 'root', 'password' => 'cleopatra410', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_15b28dc96f028fb1e68b32c06b560c5e06e716bf5326a97a2df44d1eafee505f');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_15b28dc96f028fb1e68b32c06b560c5e06e716bf5326a97a2df44d1eafee505f');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_15b28dc96f028fb1e68b32c06b560c5e06e716bf5326a97a2df44d1eafee505f');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/Library/WebServer/Documents/hasheado2/vendor/hasheado/blog-bundle/Hasheado/BlogBundle/Entity')), 'Hasheado\\BlogBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('HasheadoBlogBundle' => 'Hasheado\\BlogBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('/Library/WebServer/Documents/hasheado2/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/Library/WebServer/Documents/hasheado2/app/Resources');
    }
    ...
    /**
     * Gets the 'hasheado_blog.behaviors.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Hasheado\BlogBundle\EventListener\BehaviorsListener A Hasheado\BlogBundle\EventListener\BehaviorsListener instance.
     */
    protected function getHasheadoBlog_Behaviors_ListenerService()
    {
        return $this->services['hasheado_blog.behaviors.listener'] = new \Hasheado\BlogBundle\EventListener\BehaviorsListener();
    }

    /**
     * Gets the 'hasheado_blog.entity_id.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Hasheado\BlogBundle\Form\Type\EntityIdType A Hasheado\BlogBundle\Form\Type\EntityIdType instance.
     */
    protected function getHasheadoBlog_EntityId_TypeService()
    {
        return $this->services['hasheado_blog.entity_id.type'] = new \Hasheado\BlogBundle\Form\Type\EntityIdType($this->get('doctrine'));
    }

    /**
     * Gets the 'hasheado_blog.wysiwyg.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Hasheado\BlogBundle\Form\Type\WysiwygType A Hasheado\BlogBundle\Form\Type\WysiwygType instance.
     */
    protected function getHasheadoBlog_Wysiwyg_TypeService()
    {
        return $this->services['hasheado_blog.wysiwyg.type'] = new \Hasheado\BlogBundle\Form\Type\WysiwygType();
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Library/WebServer/Documents/hasheado2/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Library/WebServer/Documents/hasheado2/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/Library/WebServer/Documents/hasheado2/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/Library/WebServer/Documents/hasheado2/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/login$'), 'security.firewall.map.context.secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/*'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $k = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'ThisTokenIsNotSoSecretChangeIt', 'secured_area', array('lifetime' => 2592000, 'path' => 'hasheado_blog_admin_dashboard', 'domain' => NULL, 'name' => 'REMEMBERME', 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);

        $l = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $j, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($j, 'hasheado_blog_admin_login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'hasheado_blog_admin_logout'));
        $l->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());
        $l->addHandler($k);

        $m = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($j, array('login_path' => 'hasheado_blog_admin_login', 'default_target_path' => 'hasheado_blog_admin_dashboard', 'target_path_parameter' => '_target_path', 'use_referer' => true, 'always_use_default_target_path' => false));
        $m->setProviderKey('secured_area');

        $n = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $j, 'secured_area', $m, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($f, $j, array('login_path' => 'hasheado_blog_admin_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => 'hasheado_blog_admin_login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $d, NULL);
        $n->setRememberMeServices($k);

        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($i, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c), 'secured_area', $a, $d), 2 => $l, 3 => $n, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $k, $g, $a, $d), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $i, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $j, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $j, 'hasheado_blog_admin_login', false), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Library/WebServer/Documents/hasheado2/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/Library/WebServer/Documents/hasheado2/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Library/WebServer/Documents/hasheado2/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Library/WebServer/Documents/hasheado2/app', 'UTF-8');
    }
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('secured_area', 'hasheado_blog_admin_logout', 'logout', '_csrf_token', NULL);
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/Library/WebServer/Documents/hasheado2/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/Library/WebServer/Documents/hasheado2/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/Library/WebServer/Documents/hasheado2/app', 'UTF-8'));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'HasheadoBlogBundle:Form:fields.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        $instance->addExtension(new \Twig_Extension_Debug());
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'HasheadoBlogBundle'), $this->get('assetic.value_supplier.default', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
        $instance->addExtension(new \Doctrine\Bundle\DoctrineBundle\Twig\DoctrineExtension());
        $instance->addExtension($this->get('twig.extension.acme.demo'));
        $instance->addGlobal('app', $this->get('templating.globals'));
        $instance->addGlobal('blog_title', 'Hasheado Blog');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Library/WebServer/Documents/hasheado2/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/Library/WebServer/Documents/hasheado2/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/Library/WebServer/Documents/hasheado2/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/Library/WebServer/Documents/hasheado2/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/Library/WebServer/Documents/hasheado2/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/Library/WebServer/Documents/hasheado2/vendor/hasheado/blog-bundle/Hasheado/BlogBundle/Resources/views', 'HasheadoBlog');
        $instance->addPath('/Library/WebServer/Documents/hasheado2/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/Library/WebServer/Documents/hasheado2/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/Library/WebServer/Documents/hasheado2/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/Library/WebServer/Documents/hasheado2/app/Resources/views');
        $instance->addPath('/Library/WebServer/Documents/hasheado2/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Library/WebServer/Documents/hasheado2/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Library/WebServer/Documents/hasheado2/app/cache/dev/assetic/assets');
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.in_memory'), $a, 'secured_area', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($a, 'ThisTokenIsNotSoSecretChangeIt', 'secured_area')), true);
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('admin', 'bl0g@dm1n', array(0 => 'ROLE_ADMIN')));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Library/WebServer/Documents/hasheado2/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/Library/WebServer/Documents/hasheado2/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Library/WebServer/Documents/hasheado2/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Library/WebServer/Documents/hasheado2/app/cache/dev',
            'kernel.logs_dir' => '/Library/WebServer/Documents/hasheado2/app/logs',
            'kernel.bundles' => array(
                ...
                'HasheadoBlogBundle' => 'Hasheado\\BlogBundle\\HasheadoBlogBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'hasheado2',
            'database_user' => 'root',
            'database_password' => 'cleopatra410',
            ...
            'blog_title' => 'Hasheado Blog',
            'admin_items_per_list' => 10,
            'post_in_homepage' => 3,
            'popular_post_sidebar' => 5,
            'comments_sidebar' => 5,
            'tags_sidebar' => 5,
            ...
            'debug.container.dump' => '/Library/WebServer/Documents/hasheado2/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/Library/WebServer/Documents/hasheado2/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/Library/WebServer/Documents/hasheado2/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/Library/WebServer/Documents/hasheado2/app/cache/dev/profiler',
            ...
            'router.resource' => '/Library/WebServer/Documents/hasheado2/app/cache/dev/assetic/routing.yml',
            ...
            'twig.form.resources' => array(
                ...
                1 => 'HasheadoBlogBundle:Form:fields.html.twig',
            ),
            ...
            'twig.options' => array(
                ...
                'cache' => '/Library/WebServer/Documents/hasheado2/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/Library/WebServer/Documents/hasheado2/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Library/WebServer/Documents/hasheado2/app/cache/dev/assetic',
            'assetic.bundles' => array(
                0 => 'HasheadoBlogBundle',
            ),
            ...
            'assetic.read_from' => '/Library/WebServer/Documents/hasheado2/app/../web',
            'assetic.write_to' => '/Library/WebServer/Documents/hasheado2/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/Library/WebServer/Documents/hasheado2/app/cache/dev/doctrine/orm/Proxies',
